...
func main() {
    ethscan, err := etherscan.NewEtherscanFromNetwork(web3tool.Mainnet, "apiKey")
}
```
...
```go
block, err := ethscan.GetBlockByNumber(web3tool.BlockNumber(100), true)
```
