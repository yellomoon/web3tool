...
Check [examples](https://github.com/yellomoon/web3tool/tree/master/examples) for a list of examples on how to interact with a smart contract.
...
By default, `web3tool` includes builtin `abigen` contracts for `ens` and `erc20` tokens.
