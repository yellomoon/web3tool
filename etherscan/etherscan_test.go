...
func TestContract(t *testing.T) {
	...
	// uniswap v2. router
	code, err := e.GetContractCode(web3tool.HexToAddress("0x7a250d5630b4cf539739df2c5dacb4c659f2488d"))
	assert.NoError(t, err)
...
func TestGetLogs(t *testing.T) {
	...
	from := web3tool.BlockNumber(379224)
	to := web3tool.Latest

	filter := &web3tool.LogFilter{
		From: &from,
		To:   &to,
		Address: []web3tool.Address{
			web3tool.HexToAddress("0x33990122638b9132ca29c723bdf037f1a891a70c"),
		},
	}
