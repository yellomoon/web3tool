...
func (e *Entry) StoreLog(log *web3tool.Log) error {
	return e.StoreLogs([]*web3tool.Log{log})
}

// StoreLogs implements the store interface
func (e *Entry) StoreLogs(logs []*web3tool.Log) error {
...
func (e *Entry) GetLog(indx uint64, log *web3tool.Log) error {
